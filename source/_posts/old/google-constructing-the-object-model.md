...
![从字节到DOM树的过程](/img/google-translate/1.png)
...
![浏览器将CSS字节转换到CSSOM](/img/google-translate/4.png)

浏览器将CSS字节转换成字符，然后构建标记和节点，最后练级到一个叫做CSS对象模型（CSSOM）的树型数据结构

![树状CSSOM](/img/google-translate/5.png)
...
![通过开发者工具查看样式处理](/img/google-translate/6.png)
