...
![Object.create继承时的对象](/img/js_inherit/2.png)
...
![复制属性，共用原型时的对象](/img/js_inherit/3.png)
...
//输出：见下图
```
![复制属性，不共用原型时的对象](/img/js_inherit/4.png)
...
![扁平复制所有属性时的对象](/img/js_inherit/5.png)
...
//输出：见下图
```
![扁平复制父类原型属性时的对象](/img/js_inherit/6.png)
...
//输出：见下图
```
![扁平复制父类自身属性的对象](/img/js_inherit/7.png)
