...
```
效果图如下：
![Alt text](/img/verticalalign/1.png)
...
## baseline的确定
### 什么是baseline
![Alt text](/img/verticalalign/2.png)
...
![Alt text](/img/verticalalign/3.png)
...
![Alt text](/img/verticalalign/4.png)
...
![Alt text](/img/verticalalign/5.png)
...
![Alt text](/img/verticalalign/6.png)
...
![Alt text](/img/verticalalign/7.png)
...
![Alt text](/img/verticalalign/8.png)
...
![Alt text](/img/verticalalign/9.png)

审查一下文本，可以看到，蓝色的区域上边界就是文本区域：

![Alt text](/img/verticalalign/10.png)

这样就很好理解了，而可以看到对齐结果如下：

![Alt text](/img/verticalalign/11.png)
...
![Alt text](/img/verticalalign/12.png)
...
![Alt text](/img/verticalalign/15.png)

也是三条线，和上面基准一样，将子元素的baseline对齐上标的baseline：

![Alt text](/img/verticalalign/16.png)
...
![Alt text](/img/verticalalign/17.png)

并不是很直观，给它加上一个`transfrom: translate(0, 50px)`（相对下移50px）,它又移到那个熟悉的位置了：

![Alt text](/img/verticalalign/18.png)
...
![Alt text](/img/verticalalign/19.png)
...
![Alt text](/img/verticalalign/20.png)

由于规则2的计算，line box被这个big元素撑开，达到400px，如果我们将其降低到200px：

![Alt text](/img/verticalalign/21.png)
...
![Alt text](/img/verticalalign/22.png)
...
![Alt text](/img/verticalalign/23.png)
...
![Alt text](/img/verticalalign/24.png)
...
![Alt text](/img/verticalalign/25.png)
